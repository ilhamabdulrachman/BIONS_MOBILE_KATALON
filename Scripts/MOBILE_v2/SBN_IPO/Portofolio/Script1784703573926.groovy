...
Mobile.setText(findTestObject('Login_firebase/User_id'), 'BILA3', 0)
...
client.connect('REDACTED_INTERNAL_IP', 62229 // FEED_ DEV
    )

client.sendMessage('{ "action":"login", "user":"BILA3", "password":"q" }')
...
Mobile.takeScreenshot('/Users/bionsrevamp/Katalon Studio/Bions__/Reports/20250801_113059/Mobile/Login/total_porto.PNG')

//Mobile.tap(findTestObject('Redem_sbn_v2/Portofolio_v2'), 0)
Mobile.tap(findTestObject('NavBar_Scalability/Portofolio'), 0)

Mobile.takeScreenshot('/Users/bionsrevamp/Katalon Studio/Bions__/Reports/20250801_113059/Mobile/Login/total_porto1.PNG')

Mobile.tap(findTestObject('Redem_sbn_v2/Klik_stock'), 0)

Mobile.takeScreenshot('/Users/bionsrevamp/Katalon Studio/Bions__/Reports/20250801_113059/Mobile/Login/total_porto2.PNG')

Mobile.tap(findTestObject('Redem_sbn_v2/Fixed_income'), 0)

Mobile.takeScreenshot('/Users/bionsrevamp/Katalon Studio/Bions__/Reports/20250801_113059/Mobile/Login/total_porto3.PNG')

Mobile.tap(findTestObject('Redem_sbn_v2/Select_sbn'), 0)

Mobile.takeScreenshot('/Users/bionsrevamp/Katalon Studio/Bions__/Reports/20250801_113059/Mobile/Login/total_porto4.PNG')

Mobile.tap(findTestObject('Redem_sbn_v2/SBN'), 0)

Mobile.takeScreenshot('/Users/bionsrevamp/Katalon Studio/Bions__/Reports/20250801_113059/Mobile/Login/total_porto5.PNG')

Mobile.tap(findTestObject('Redem_sbn_v2/MASKING'), 0)

Mobile.takeScreenshot('/Users/bionsrevamp/Katalon Studio/Bions__/Reports/20250801_113059/Mobile/Login/total_porto6.PNG')

Mobile.delay(4, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot('/Users/bionsrevamp/Katalon Studio/Bions__/Reports/20250801_113059/Mobile/Login/total_porto7.PNG')

BigDecimal total = OrderVerification.calculateTotalMarketValue("BILA3")
KeywordUtil.logInfo("Total Market Value: ${total}")
