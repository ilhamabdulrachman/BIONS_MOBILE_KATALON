...
Mobile.tap(findTestObject('Watchlist/Edit'), 0)

Mobile.tap(findTestObject('Watchlist/deleted'), 0)

Mobile.tap(findTestObject('Watchlist/deleted_yes'), 0)

boolean isDeleted = OrderVerification.verifyStockFavoriteGroupDeleted('1B029', 'KTW4')
