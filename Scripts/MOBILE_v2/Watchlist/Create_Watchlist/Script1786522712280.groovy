...
Mobile.tap(findTestObject('Watchlist/Setting_watchlist'), 0)

Mobile.swipe(500, 1500, 500, 500)

Mobile.tap(findTestObject('Watchlist/Create_Watchlist'), 0)

Mobile.setText(findTestObject('enter watchlist name'), 'KTW4', 0)

Mobile.tap(findTestObject('Watchlist/w_save'), 0)

//int totalFavorite = OrderVerification.listAllStockFavoriteWithGroupName('1B029')
OrderVerification.verifyStockFavoriteGroupNameExists('1B029', 'KTW4')

Mobile.takeScreenshot('/Users/bionsrevamp/Katalon Studio/Bions__/Reports/20250801_113059/Mobile/Login/Login1_V2.PNG')

Mobile.tap(findTestObject('Watchlist/add_stock'), 0)

Mobile.tap(findTestObject('Watchlist/stock1'), 0)

Mobile.tap(findTestObject('Watchlist/stock2'), 0)

Mobile.tap(findTestObject('Watchlist/done'), 0)
