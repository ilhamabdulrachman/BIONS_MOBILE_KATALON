...
Mobile.tap(findTestObject('Transaksi/TABSELL'), 1)
...
KeywordUtil.logInfo('You Cannot Sell these shares as the are not in your portofolio (rejected as they are ba\'al-maksyuf)\nDo Not sell something that you do not have (HR:AL KHOMSAH From Hukaim Bin Hizam)')

Mobile.tap(findTestObject('Transaksi/Sell_/BACK_TO_ORDER'), 0)
