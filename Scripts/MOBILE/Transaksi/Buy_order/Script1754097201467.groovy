...
Mobile.setText(findTestObject('TEST_LOGIN/pin'), 'REDACTED_PIN33', 0)
...
client.connect("REDACTED_PROD_HOST", 62229)
...
client.sendMessage('{ "action":"subscribe", "channel":"order", "user":"REDACTED_USERID" }')
