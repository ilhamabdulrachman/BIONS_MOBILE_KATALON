...
String stockCode = 'TLKM' // Ditambahkan: Sesuaikan dengan saham yang di-order

BigDecimal orderPrice = new BigDecimal('328')
...
Mobile.setText(findTestObject('Transaksi/STOCK_NAME'), 'TLKM', 0)
