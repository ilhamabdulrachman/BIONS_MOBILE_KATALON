...
Mobile.setText(findTestObject('login_v191/USER ID'), 'REDACTED_USERID', 0)

Mobile.setText(findTestObject('login_v191/paswword'), 'REDACTED_PIN22', 0)

Mobile.setText(findTestObject('login_v191/pin'), 'REDACTED_PIN33', 0)
